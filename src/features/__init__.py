...
DATASET_LOADERS = {
    ...
    'M4-month': M4Dataset(path='data/raw/m4-monthly', cache_folder=cache_folder + 'm4-monthly'),
    'M4-week': M4Dataset(path='data/raw/m4-weekly', cache_folder=cache_folder + 'm4-weekly'),
    'M4-quarter': M4Dataset("data/raw/m4-quarterly", cache_folder=cache_folder + 'm4-quarterly'),
